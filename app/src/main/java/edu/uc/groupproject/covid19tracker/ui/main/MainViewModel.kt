...
class MainViewModel : ViewModel() {
    ...
    fun globalData() {
        GlobalScope.launch(context = Dispatchers.Main) {
            val gdp : GlobalDataProvider = GlobalDataProvider()
             ...
             */
            val globalDataDto = GlobalData(gCases!!.get(0), gActive!!.get(0),
            ...
            val cbc : CasesByCountryDataProvider = CasesByCountryDataProvider()
